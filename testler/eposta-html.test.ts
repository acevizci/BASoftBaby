...
describe("e-posta HTML", () => {
  it("başlıkta tam adresli PNG logo", () => {
    ...
    assert.match(h, /<img src="https:\/\/www\.basoftbaby\.com\/marka\/basoftbaby-logo-256\.png"[^>]*alt="BASoftBaby"/);
  });
  ...
  it("adresler bağlantı; sondaki nokta bağlantıya girmiyor", () => {
    ...
    assert.match(h, /<a href="https:\/\/www\.basoftbaby\.com\/siparis-takip\?numara=BA-1&amp;eposta=a%40b\.c"/);
    assert.match(h, /<\/a>\.<\/p>/);
  });
