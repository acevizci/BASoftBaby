 ...
 * bırakıyordu (K-48).
 *
 * **Çerçeve burada yok:** bu kopya `(magaza)` grubunun içinde, grubun düzeni
 * duyuru şeridini, üst çubuğu ve alt bilgiyi zaten çiziyor. Kök kopyada
 * çerçeve elle çiziliyor, çünkü orası grubun dışında — ikisini birleştirmek
 * üst çubuğun iki kez basılması demekti.
 */
export default async function MagazadaBulunamadi() {
